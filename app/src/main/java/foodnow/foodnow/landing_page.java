    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBtnCustomer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent customerlogin = new Intent(landing_page.this,customer_login.class);
        ...
        mBtnOwner.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent ownerlogin = new Intent(landing_page.this,owner_login.class);
        ...
        mBtnGuest.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent guest = new Intent(landing_page.this,customer_home.class);
                startActivity(guest);
