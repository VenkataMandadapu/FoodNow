...
public class customer_login extends AppCompatActivity {
    ...
    //public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            /*View rootView = inflater.inflate(R.layout.fragment_customer_login, container, false);
            TextView textView = (TextView) rootView.findViewById(R.id.section_label);
            textView.setText(getString(R.string.section_format, getArguments().getInt(ARG_SECTION_NUMBER)));
            return rootView;*/

            /*if(getArguments().getInt(ARG_SECTION_NUMBER) == 1){
                View rootView1 = inflater.inflate(R.layout.fragment_customer_logon, container, false);
                return rootView1;
            }
            else {
                View rootView1 = inflater.inflate(R.layout.fragment_customer_signup, container, false);
                return rootView1;
            }
        }
    }*/
    ...
    public class LoginPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (position){
                case LOGIN_TAB:
                    return new customer_logon();
                case SIGNUP_TAB:
                    return new customer_signup();
                default:
                    return null;
            }
        }
