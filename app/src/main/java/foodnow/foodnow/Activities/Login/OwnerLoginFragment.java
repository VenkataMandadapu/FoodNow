...
public class OwnerLoginFragment extends Fragment implements View.OnClickListener, GoogleApiClient.OnConnectionFailedListener {
...
//        }
    ...
    private void openHomeScreenOwnerLogin(){
        Log.d(LOG_TAG, "openHomeScreenOwnerLogin() called");
        Intent homeScreen = new Intent(getActivity(), OwnerHome.class);
